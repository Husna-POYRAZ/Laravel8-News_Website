...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $slider = Haber::select('id','title','image','type','slug','description')->where('status','=','True')->limit(4)->get();


        $popular = Haber::select('id','title','image','type','slug')->where('status','=','True')->limit(6)->inRandomOrder()->get();
        $last = Haber::select('id','title','image','type','slug')->where('status','=','True')->limit(6)->orderByDesc('id')->get();
        $news = Haber::select('id','title','image','type','slug','description')->where('status','=','True')->limit(10)->inRandomOrder()->get();
