            ...
            <div class="col-md-4">
                ...
                <div class="logo footer-logo">
                    <a title="fontanero" href="{{route('home')}}">
                        <img src="{{asset('assets')}}/img/tech_about.png" height="200" width="235" alt="technews">
                    </a>
        ...
        <div class="container">
            <div class="row">
                <div class="footer">
                    ...
                    <div class="col-sm-6">
                        <p>&copy 2022 BBC. The BBC is not responsible for the content of external sites. Read about our approach to external linking. <a href="https://github.com/Husna-POYRAZ">BBC News</a> </p>
                    </div>
                    <div class="col-sm-3">
                        <p>BBC News</p>
                    </div>
