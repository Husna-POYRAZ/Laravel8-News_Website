...
@foreach($slider as $rs)
                        <div class="item @if($loop->first) active @endif">
                            <img class="img-responsive" src="{{Storage::url($rs->image)}}" style="height:500px " alt="">
                            <div class="feature_article_inner">
                                <div class="tag_lg red"><a href="">{{$rs->type}}</a></div>
                                <div class="feature_article_title">
                                    <h1><a href="{{route('haber', ['id' => $rs->id, 'slug'=> $rs->slug])}}" target="_self">{{$rs->title}}</a></h1>
                                </div>
